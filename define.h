...
const float OPACITY_INCREASE = 0.035;
...
enum BUTTONS { PLAY_BUTTON, OPTIONS_BUTTON, HIGHSCORES_BUTTON, EXIT_BUTTON, NEW_STORY_BUTTON, LOAD_GAME_BUTTON, NEW_RANDOM_BUTTON, MUSIC_VOLUME_BUTTON, SOUND_VOLUME_BUTTON, RESET_PROFILE_BUTTON, GAME_AREA_BUTTON, MAX_BUTTONS };
