...
//enum BUTTONS { PLAY_BUTTON, OPTIONS_BUTTON, SCORES_BUTTON, EXIT_BUTTON, NEW_STORY_BUTTON, LOAD_GAME_BUTTON, NEW_RANDOM_BUTTON, MUSIC_MUTE_BUTTON, SOUND_MUTE_BUTTON, RESET_PROFILE_BUTTON, GAME_AREA_BUTTON,OPTIONS_POPUP,HIGHSCORES_POPUP,HIGHSCORES_END, MAX_BUTTONS };
enum BUTTONS { PLAY_BUTTON, OPTIONS_BUTTON, SCORES_BUTTON, EXIT_BUTTON, LOAD_GAME_BUTTON, NEW_RANDOM_BUTTON, GAME_AREA_BUTTON,/* OPTIONS_POPUP, HIGHSCORES_POPUP, SOUND_MUTE_BUTTON,*/ MAX_BUTTONS};
...
enum GAME_STATE {PLAY_GAME, REFRESH_GAME, SCORES, OPTIONS, END_GAME, SAVING_SCORE, CHEAT, MAIN_MENU};
